...
public class NovaNoticiaGerenciadorServlet extends HttpServlet {
	...
	private String generateHtml(String titulo) {
		String html =
				...
				"					</div>\n" + 
				"					<div class=\"col-89\">\n" + 
				"						<input name=\"titulo\" type=\"text\" placeholder=\"Digite o título da notícia..\" />\n" + 
				"					</div>\n" + 
				"				</div>\n" + 
				"				<div class=\"row\">\n" + 
				"					<div class=\"col-11\">\n" + 
				...
				"					</div>\n" + 
				"					<div class=\"col-89\">\n" + 
				"						<textarea name=\"descricao\" placeholder=\"Descreva a notícia em poucas palavras..\" style=\"height: 60px\"></textarea>\n" + 
				"					</div>\n" + 
				"				</div>\n" +
				"				<div class=\"row\">\n" + 
				"					<div class=\"col-11\">\n" + 
				...
				"					</div>\n" + 
				"					<div class=\"col-89\">\n" + 
				"						<textarea name=\"texto\" placeholder=\"Aqui vai o texto da notícia!\" style=\"height: 600px\"></textarea>\n" + 
				"					</div>\n" + 
				"				</div>\n" +
				"				<div class=\"row\">\n" + 
